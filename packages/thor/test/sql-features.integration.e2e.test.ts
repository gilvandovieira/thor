...
const MYSQL_RESET = [
  "drop table if exists users",
  "create table users (id int auto_increment primary key, email varchar(255) not null unique, name text, age int, created_at timestamp not null default current_timestamp)",
  "insert into users (email, name, age) values ('seed@x.c', 'Seed', 30)"
]
