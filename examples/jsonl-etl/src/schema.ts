...
export const sources = sqlite.table("sources", {
...
export const rawEvents = sqlite.table("raw_events", {
...
export const dailyMetrics = sqlite.table("daily_metrics", {
  id: sqlite.text("id").primaryKey(),
  sourceId: sqlite.text("source_id").notNull(),
...
export const importRuns = sqlite.table("import_runs", {
